  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .watermark {
      ...
      font-size: 180px;
      color: rgba(15, 43, 70, 0.04);
      font-weight: bold;
      pointer-events: none;
    }
    .logo { margin-bottom: 15px; }
    .title { font-size: 48px; color: #0F2B46; font-weight: bold; margin: 30px 0 10px; letter-spacing: 2px; }
    .subtitle { font-size: 20px; color: #64748b; margin-bottom: 40px; }
    .presented { font-size: 18px; color: #475569; margin-bottom: 10px; }
    .name { font-size: 42px; color: #1e293b; font-weight: bold; margin: 10px 0; border-bottom: 2px solid #0F2B46; display: inline-block; padding: 0 20px 10px; }
    .course { font-size: 22px; color: #0F2B46; margin: 20px 0; }
