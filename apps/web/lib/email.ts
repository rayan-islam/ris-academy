    ...
    <div style="max-width:480px;margin:0 auto;font-family:Arial,sans-serif">
      ...
      <div style="padding:24px;border:1px solid #e5e7eb;border-top:0">
        ...
        <div style="background:#f3f4f6;padding:16px;text-align:center;border-radius:8px;margin-bottom:16px">
          <span style="font-size:28px;font-weight:700;letter-spacing:4px;color:#185FA5">${otp}</span>
        </div>
  ...
  const html = `
    <div style="max-width:480px;margin:0 auto;font-family:Arial,sans-serif">
      ...
      <div style="padding:24px;border:1px solid #e5e7eb;border-top:0">
        ...
        <a href="${resetUrl}" style="display:inline-block;background:#185FA5;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:600;margin-bottom:16px">Reset Password</a>
